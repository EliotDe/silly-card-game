...
public class TestGameLogger {
    ...
    public void testInitializeLogFile(){
        ...
        try {
            ...
            String filePath = currentDir + File.separator + "outputs" + File.separator + "player" + player.getPreferredValue() + "_output.txt";
            ...
            assertEquals("Player" + player.getPreferredValue() + " initial hand: \n", fileContent.toString());

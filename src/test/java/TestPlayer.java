...
import main.java.DeckModificationEvent;
...
//        Card card2 = new Card(new AtomicInteger(1));
//        Card card3 = new Card(new AtomicInteger(1));
//        Card card4 = new Card(new AtomicInteger(1));
//
//        hand.dealCard(card1);
//        hand.dealCard(card2);
//        hand.dealCard(card3);
